...
class ConfigProvider implements ConfigProviderInterface
{
    ...
    protected $methodCodes = [
        ...
        'payssion_payment_bankcard_tr',
        'payssion_payment_banktransfer_tr',
        ...
        'payssion_payment_easypaisa_pk',
        'payssion_payment_ebanking_za',
        ...
        'payssion_payment_jazzcash_pk',
        'payssion_payment_konnect_pk',
        'payssion_payment_linkaja_id',
